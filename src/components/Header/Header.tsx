...
return (
    ...
    <h1 className="relative text-4xl font-extrabold bg-custom-text  bg-clip-text text-transparent gradient-overlay">
        ...
        <span className='text-sm ml-16  bg-gradient-to-r from-yellow-700 to bg-gray-500 bg-clip-text text-transparent  font-semibold animate-textGlow'>WHY ME -- TRY ME</span>
        </div>   
        </div>
    <NavLinks/>
    </div>
